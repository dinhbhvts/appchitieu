...
This wires Alembic to our application: it reads the database URL from our
Settings and points autogenerate at our models' metadata, so
...
# Inject the real database URL from our application settings.
